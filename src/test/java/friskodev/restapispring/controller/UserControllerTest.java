...
class UserControllerTest {
    ...
    void testRegisterSuccess() throws Exception {
        ...
        request.setUsername("frisko");
        request.setPassword("kambing");
        request.setName("Frisko");
    ...
    void testRegisterDuplicate() throws Exception {
        User user = new User();
        user.setUsername("frisko");
        user.setPassword(BCrypt.hashpw("kambing", BCrypt.gensalt()));
        user.setName("Frisko");
